...
func parseTokenStatusQuery(c *gin.Context) int {
...
func GetAllTokens(c *gin.Context) {
	...
	status := parseTokenStatusQuery(c)
	tokens, err := model.GetAllUserTokens(userId, pageInfo.GetStartIdx(), pageInfo.GetPageSize(), status)
	if err != nil {
		common.ApiError(c, err)
		return
	}
	total, _ := model.CountUserTokensWithStatus(userId, status)
