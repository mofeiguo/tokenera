...
function SidebarInset({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'bg-background relative flex w-full flex-1 flex-col md:peer-data-[variant=inset]:m-1 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-2xl md:peer-data-[variant=inset]:shadow-[0_1px_4px_0_rgba(0,0,0,0.05)] md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-1',
        className
      )}
      {...props}
    />
