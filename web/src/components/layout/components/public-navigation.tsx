      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            to={link.href}
            aria-current={
              routerState.location.pathname === link.href ? 'page' : undefined
            }
            className={cn(
              'text-muted-foreground hover:bg-accent hover:text-accent-foreground focus-visible:ring-ring inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:outline-none',
